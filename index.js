...
async function startHisoka() {
    ...
    let pa7rick = await hisoka.sendTextWithMentions(tihh.from, `*${hisoka.user.name}* tidak bisa menerima panggilan ${tihh.isVideo ? `video` : `suara`}. Maaf @${tihh.from.split('@')[0]} kamu akan diblockir secara otomatis. Jika tidak sengaja silahkan hubungi Owner untuk dibuka !`)
