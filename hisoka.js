...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Anti Link
        ...
        m.reply(`「 ANTI LINK 」\n\nKamu terdeteksi mengirim link group lain, kamu akan di kick dari group ini !`)
        if (!isBotAdmins) return m.reply(`Jadikan  T_T`)
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/74fd634010128be37972c.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 9k Per Group permanen via E-Walet\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6285877276864 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : https://www.paypal.me/Cakhaho\n⭔ Saweria : https://saweria.co/Adisdzaky` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('Script : https://github.com/Adisdzaky\n\n Dont Forget Give Star\n\nDonate : 6285877276864 (Link Aja)\nSaweria : https://saweria.co/Adisdzaky\nPaypal : https://www.paypal.me/Cakhaho\n\n Dont Forget Donate')
            }
            break
            case 'chat': {
